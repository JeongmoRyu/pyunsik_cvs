...
public class RedisService  {
    ...
    public Map<String, List<Map<String, String>>> getKeywordRanking() {
        ...
        try {
            result = objectMapper.readValue(jsonStr, new TypeReference<Map<String, List<Map<String, String>>>>() {});
    ...
    public List<Long> getPopularProductsByCategory(int category) {
        ...
        try {
            productIds = objectMapper.readValue(jsonStr, new TypeReference<List<Long>>() {});
        } catch (JsonProcessingException e) {
            e.printStackTrace();
